...
A maioria dos ERPs tradicionais apresenta três grandes problemas:

* Alto custo
* Interfaces complexas
* Implantação lenta

Soluções como ERPs corporativos geralmente são pesadas para pequenas distribuidoras.
...
> Qualquer funcionário deve aprender a usar o sistema em poucos minutos.
